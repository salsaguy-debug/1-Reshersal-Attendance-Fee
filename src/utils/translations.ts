...
export const translations = {
  en: {
    ...
    syncRev74Desc: 'Full Multi-Source Sync: Google Calendar + Live Form Submissions',
    forceUpdateMonths: 'Refresh Months & Tab Structure',
    forceUpdateMonthsDesc: 'Scan & refresh active 2026 month tabs (April–December)',
  ...
  es: {
    ...
    syncRev74Desc: 'Sincronización multi-fuente: Google Calendar + Formularios en vivo',
    forceUpdateMonths: 'Recargar Meses y Estructura',
    forceUpdateMonthsDesc: 'Escanear y actualizar pestañas activas de meses (Abril–Diciembre)',
